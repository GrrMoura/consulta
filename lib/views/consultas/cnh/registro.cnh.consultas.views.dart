...
class RegistroCnhConsultasView extends StatefulWidget {
  RegistroCnhConsultasView({Key key, this.model}) : super(key: key);

  final ConsultaViewModel model;

  @override
  _RegistroCnhConsultasViewState createState() =>
      _RegistroCnhConsultasViewState();
}

class _RegistroCnhConsultasViewState extends State<RegistroCnhConsultasView> {
  ...
  Widget build(BuildContext context) {
    ...
    final identificacaoTextField = Container(
      ...
      child: TextFormField(
        ...
        validator: (value) {
          if (value.isEmpty) return "Por favor, informe um registro.";
          if (value.length != 11) return "Registro incompleto";
          return null;
        },
        onSaved: (val) {
